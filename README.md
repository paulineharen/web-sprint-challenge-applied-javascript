...
1. What is the DOM?
It a live representation of HTML data that can be accessed and manipulated.

2. What is an event?

An event is something that has been triggered due to a user's action.

3. What is an event listener?

An even listener waits for the events and executes.

4. Why would we convert a NodeList into an Array?

To be able to manipulate it further with methods such as .map or .filter.

5. What is a component?

A component is single modular piece of code that can be reused.
